...
public class TermToPostingCompressor {
    private static final int TERMS_IN_BLOCK = 4;

    static void writeCompressedMapping(File file, Map<String, Integer> postingAddr) throws IOException {
